...
// Sealed Class são classes abstratas, onde suas subclasses não podem ser acessadas fora dela
// Nesse caso, como temos vários tipos de filtros, podemos criar um método abstrato chamado filtra
// e criar uma classe para cada tipo diferente de filtro, que implementa o método abstrato.
@Introspected
sealed class Filtro {
